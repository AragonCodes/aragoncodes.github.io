...
$(document).ready(function () {
  ...
  $('.modal').modal();
  $('.modal-trigger-hey-kevin').on( 'click', function () { $('.modal-hey-kevin').modal('open'); });
  ...
  // ## Magic Scroll
  // #################################  
  var passedMagicCards = false;
    if ((initScrollTop+windowHeight) >= $(".hide-magic-cards-home").offset().top) {
      passedMagicCards = true;
      $(".magic-card-home").css("opacity","0");
    }
    var magicController = new ScrollMagic.Controller({ globalSceneOptions: { triggerHook: '0.12' }});
  ...
  $(window).scroll(function(event) {
    ...
    // ## Magic Scroll
    // #################################
    if (((scrollBottom) >= $(".hide-magic-cards-home").offset().top) && !(passedMagicCards)) {
      $(".magic-card-home").not('.magic-card-home-6').css("opacity","0");
      $(".magic-card-home").fadeTo( "slow", 0 );
      passedMagicCards = true;
    }
    else if (((scrollBottom) < $(".hide-magic-cards-home").offset().top) && (passedMagicCards)) {
